...
Task: Open the microwave door on a kitchen table, with vegetable distractors on the table.
...
class MicrowaveOpenKitchenEnvironment(ExampleEnvironmentBase):
    """Open the microwave door on a kitchen table, with vegetable distractors on the table."""

    name: str = "microwaveOpenkitchen"
    ...
    def get_env(self, args_cli: argparse.Namespace) -> IsaacLabArenaEnvironment:
        ...
        return IsaacLabArenaEnvironment(
            ...
            task=OpenDoorTask(
                ...
                task_description="Open the microwave door on a kitchen table, with vegetable distractors on the table.",
            ),
        )
