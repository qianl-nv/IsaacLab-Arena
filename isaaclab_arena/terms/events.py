...
def _deformable_nodal_state_for_pose(
    ...
    """Transform an asset's default nodal state to an environment-local centroid pose."""
    ...
    nodal_state[..., :3] = asset.transform_nodal_pos(default_pos_w, target_pos_w - default_centroid_w, delta_quat)
    if velocity is None:
        nodal_state[..., 3:] = 0.0
    else:
