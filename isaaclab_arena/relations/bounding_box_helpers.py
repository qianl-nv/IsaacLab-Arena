...
def has_heterogeneous_objects(objects: list[PlacementAsset]) -> bool:
...
def assign_variants_for_envs(objects: list[PlacementAsset], num_envs: int, placement_seed: int | None = None) -> None:
...
def get_bounding_box_per_env(obj: PlacementAsset, num_envs: int) -> AxisAlignedBoundingBox:
...
class PerEnvBoundingBoxes:
    ...
    object_bboxes: dict[PlacementAsset, AxisAlignedBoundingBox]
    num_envs: int
    ...
    def get_bounding_boxes_for_env_id(self, env_id: int) -> dict[PlacementAsset, AxisAlignedBoundingBox]:
    ...
    def get_bounding_boxes_for_all_envs(self) -> list[dict[PlacementAsset, AxisAlignedBoundingBox]]:
...
def build_per_env_bounding_boxes(objects: list[PlacementAsset], num_envs: int) -> PerEnvBoundingBoxes:
